...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 256.0, 446.0, 228.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "2toner",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 256.0, 603.0, 168.0, 108.0 ],
					"prototypename" : "pixl",
					"varname" : "projectr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 256.0, 192.0, 268.0, 234.0 ],
					"prototypename" : "pixl",
					"varname" : "bfgener8r",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-33::obj-53" : [ "pictctrl[12]", "pictctrl[1]", 0 ],
			...
			"obj-33::obj-64" : [ "pictctrl[11]", "pictctrl[1]", 0 ],
			...
			"snapshot" : 			{
				"valuedictionary" : 				{
					"parameter_values" : 					{
						...
						"live.toggle[1]" : 0.0,
						"toggle" : 1.0,
						"Speed" : 1.196850393700787,
						"Zoom hi" : 16.0,
						"Zoom lo" : 2.0,
						"blob" : 						{
							"Color 1" : [ 1.0, 1.0, 1.0, 1.0, 0.638297872340426, 1.0, 1.0 ],
							"Color 2" : [ 0.043527073330349, 0.633691219573325, 1.0, 1.0, 0.563829787234043, 1.0, 0.521763536665175 ],
							"Fullscreen" : [ 0 ],
							"range[1]" : [ 1 ],
							"textbutton[3]" : [ 1 ],
							"Zoom range[2]" : [ 1 ]
			...
			"snapshotlist" : 			{
				...
				"entries" : [ 					{
						...
						"fileref" : 						{
							...
							"filepos" : -1,
							"snapshotfileid" : "0843553e415ca04bf8a3e1bd19612e96"
						}
...
, 					{
						...
						"fileref" : 						{
							...
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "a4f53c406143727486d40b3798c710f1"
						}
...
, 					{
						...
						"fileref" : 						{
							...
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "112d53e15746651872ab2155bfbb6c25"
						}
...
, 					{
						...
						"fileref" : 						{
							...
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "0b75a9f79134c2fc53a7cc28ae2b9c60"
						}
...
, 					{
						...
						"fileref" : 						{
							"name" : "Untitled1[4]",
							"filename" : "Untitled1[4].maxsnap",
							"filepath" : "~/Documents/Max 8/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "184ec8fd87a0539d13fa7030d4821443"
						}
